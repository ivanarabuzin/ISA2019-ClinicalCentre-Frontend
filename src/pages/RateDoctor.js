...
import { getRateDoctors } from '../services/UserService';
...
import RateDoctorPage from './RateDoctorPage';

class RateDoctor extends TablePage {
    ...
    renderAddContent() {
        return <RateDoctorPage onCancel={ this.onCancel } onFinish={ this.onFinish } doctor={ this.state.doctor }/>
    }

    handleRate(item) {

        this.state.doctor = item;
...
export default withSnackbar(withRouter(connect(mapStateToProps, mapDispatchToProps)(RateDoctor)));