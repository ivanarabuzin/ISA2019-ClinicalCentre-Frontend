...
import { getAppointments, getUnconfirmedAppointments } from '../services/AppointmentService';
import IconButton from "@material-ui/core/IconButton";
import MoreVert from '@material-ui/icons/MoreVert';
import ApproveAppointment from "../pages/ApproveAppointment";

class UnconfirmedAppointments extends TablePage {
    ...
    getPageHeader() {
        return <h1>Unconfirmed Appointments</h1>;
    }

    renderAddContent() {
        return <ApproveAppointment onCancel={ this.onCancel } onFinish={ this.onFinish }
            appointment={ this.state.selectedItem }
        />
    }
        ...
        return(
            <TableCell>
                ...
                </IconButton>
                {
                    ...
                    >
                        <MenuItem onClick={ () => this.handleApprove(item) }>
...
export default withSnackbar(withRouter(connect(mapStateToProps, mapDispatchToProps)(UnconfirmedAppointments)));